...
class DistributionIdManagerTest {
    ...
    @Test
    fun `WHEN the provider is null AND the DT app is installed THEN the proper ID is returned`() = runBlocking {
        val subject =
            DistributionIdManager(
                packageManager = testContext.packageManagerWrapper,
                testBrowserStoreProvider,
    ...
    @Test
    fun `WHEN the provider is null AND the DT app is not installed THEN the proper ID is returned`() = runBlocking {
        val subject =
            DistributionIdManager(
                packageManager = testContext.packageManagerWrapper,
                testBrowserStoreProvider,
    ...
    @Test
    fun `WHEN the distribution is not default or mozilla online THEN the distribution is from a deal`() = runBlocking {
        val subject =
            DistributionIdManager(
                packageManager = testContext.packageManagerWrapper,
                testBrowserStoreProvider,
    ...
    @Test
    fun `WHEN the distribution should skip the marketing screen THEN the marketing screen is skipped`() = runBlocking {
        val subject =
            DistributionIdManager(
                packageManager = testContext.packageManagerWrapper,
                testBrowserStoreProvider,
    ...
    @Test
    fun `WHEN checking the distribution startup strategy THEN the correct strategy is returned`() = runBlocking {
        val subject =
            DistributionIdManager(
                packageManager = testContext.packageManagerWrapper,
                testBrowserStoreProvider,
    ...
    @Test
    fun `WHEN the provider is aura THEN the proper distribution ID is returned`() = runBlocking {
        val subject =
            DistributionIdManager(
                packageManager = testContext.packageManagerWrapper,
                testBrowserStoreProvider,
    ...
    @Test
    fun `WHEN there is a saved ID THEN the saved ID is returned`() = runBlocking {
        val subject =
            DistributionIdManager(
                packageManager = testContext.packageManagerWrapper,
                testBrowserStoreProvider,
    ...
    @Test
    fun `WHEN there is not a saved ID THEN a non blank ID is returned`() = runBlocking {
        val subject =
            DistributionIdManager(
                packageManager = testContext.packageManagerWrapper,
                testBrowserStoreProvider,
