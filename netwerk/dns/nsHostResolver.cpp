...
/* static */ void nsHostResolver::DrainCallbacks(
...
void nsHostResolver::Shutdown() {
  ...
  // Callbacks collected during ClearAll; fired outside the lock below.
  struct PendingAbort {
  ...
  // Fire collected callbacks now that the lock is released.
