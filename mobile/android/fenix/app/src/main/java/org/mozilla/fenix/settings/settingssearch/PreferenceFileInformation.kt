 ...
 *
 * @property xmlResourceId The resource ID of the xml file that the item comes from, or `null` for Compose-based screens
 *   that have no backing XML file and are indexed via a [SettingsSearchProvider].
...
sealed class PreferenceFileInformation(
    ...
    object DefaultSearchEnginePreferences :
        PreferenceFileInformation(
    ...
    object DownloadsSettingsPreferences :
        PreferenceFileInformation(
    ...
    object OpenLinksInAppsPreferences :
        PreferenceFileInformation(
    ...
    object PrivateBrowsingPreferences :
        PreferenceFileInformation(
    ...
    object SearchSettingsPreferences :
        PreferenceFileInformation(
    ...
    object SiteSettingsPreferences :
        PreferenceFileInformation(
    ...
    object TrackingProtectionPreferences :
        PreferenceFileInformation(
    ...
    object SecretSettingsPreferences :
        PreferenceFileInformation(
    ...
    /**
     * Represents the "Data Collection" settings screen. This screen is Compose-based and has no backing XML preference
     * file.
     */
    object DataChoicesPreferences :
        PreferenceFileInformation(
    ...
    /**
     * Represents the "Firefox Labs" settings screen. This screen is Compose-based and has no backing XML preference
     * file.
     */
    object FirefoxLabsPreferences :
        PreferenceFileInformation(
            topBreadcrumbResourceId = R.string.settings_title,
            categoryHeaderResourceId = R.string.preferences_category_advanced,
