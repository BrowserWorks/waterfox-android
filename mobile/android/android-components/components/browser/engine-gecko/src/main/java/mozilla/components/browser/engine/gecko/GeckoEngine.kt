...
class GeckoEngine(
    ...
    private val webExtensionActionHandler =
    ...
    private val webExtensionTabHandler =
        object : TabHandler {
            override fun isInPrivateBrowsing(): Boolean = webExtensionDelegate?.isInPrivateBrowsing() ?: false
    ...
    @kotlin.OptIn(ExperimentalAndroidComponentsApi::class) private var ipProtectionHandler: IPProtectionHandler? = null
    ...
    init {
        runtime.delegate = GeckoRuntime.Delegate {
            ...
            @Suppress("TooGenericExceptionThrown") throw RuntimeException("GeckoRuntime is shutting down")
        }
    }

    /**
     * Notifies Gecko observers of "mobile-telemetry-pref-changed". The data is "enabled" or "disabled" based on
     * [enabled]
     *
    ...
    override fun getTrackersLog(
        ...
        runtime.contentBlockingController
            .getLog(geckoSession)
            .then(
                { contentLogList ->
    ...
    override fun getTrackingProtectionEventsByDateRange(
        ...
        runtime.contentBlockingController
            .getTrackingDbEventsByDateRange(dateFrom, dateTo)
            .then(
                { eventList ->
                    val events =
                        eventList?.mapNotNull {
    ...
    override fun uninstallWebExtension(
        ...
        runtime.webExtensionController
            .uninstall((ext as GeckoWebExtension).nativeExtension)
            .then(
                {
                    onSuccess()
                    GeckoResult<Void>()
    ...
    override fun updateWebExtension(
        ...
        runtime.webExtensionController
            .update((extension as GeckoWebExtension).nativeExtension)
            .then(
                { geckoExtension ->
    ...
    override fun registerWebExtensionDelegate(webExtensionDelegate: WebExtensionDelegate) {
        ...
        val debuggerDelegate =
            object : WebExtensionController.DebuggerDelegate {
                override fun onExtensionListUpdated() {
                    webExtensionDelegate.onExtensionListUpdated()
                }
            }

        val addonManagerDelegate =
            object : WebExtensionController.AddonManagerDelegate {
                ...
                override fun onInstallationFailed(
                    ...
                    val exception = GeckoWebExtensionException.createWebExtensionException(installException)
    ...
    override fun enableWebExtension(
        ...
        runtime.webExtensionController
            .enable((extension as GeckoWebExtension).nativeExtension, source.id)
            .then(
                {
    ...
    override fun disableWebExtension(
        ...
        runtime.webExtensionController
            .disable((extension as GeckoWebExtension).nativeExtension, source.id)
            .then(
                {
                    val disabledExtension =
                        GeckoWebExtension(
                            nativeExtension = it!!,
                            runtime = runtime,
                        )
    ...
    override fun registerWebNotificationDelegate(webNotificationDelegate: WebNotificationDelegate) {
        runtime.webNotificationDelegate = GeckoWebNotificationDelegate(webNotificationDelegate)
    }

    /** See [Engine.registerWebPushDelegate]. */
    override fun registerWebPushDelegate(webPushDelegate: WebPushDelegate): WebPushHandler {
    ...
    override fun registerActivityDelegate(activityDelegate: ActivityDelegate) {
        /*
    ...
    override fun registerScreenOrientationDelegate(delegate: OrientationDelegate) {
    ...
    override fun registerPrefObserverDelegate(prefObserverDelegate: BrowserPrefObserverDelegate) {
        runtime.preferencesObserverDelegate = GeckoPreferenceObserverDelegate(delegate = prefObserverDelegate)
    }
    ...
    override fun registerPrefForObservation(
        ...
        geckoPreferenceAccessor
            .registerGeckoPrefForObservation(pref)
            .then(
                {
                    onSuccess()
                    GeckoResult<Void>()
    ...
    override fun registerPrefsForObservation(
        ...
        geckoPreferenceAccessor
            .registerGeckoPrefsForObservation(prefs)
            .then(
                {
                    onSuccess()
                    GeckoResult<Void>()
    ...
    override fun unregisterPrefForObservation(
        ...
        geckoPreferenceAccessor
            .unregisterGeckoPrefForObservation(pref)
            .then(
                {
                    onSuccess()
                    GeckoResult<Void>()
    ...
    override fun unregisterPrefsForObservation(
        ...
        geckoPreferenceAccessor
            .unregisterGeckoPrefsForObservation(prefs)
            .then(
                {
                    onSuccess()
                    GeckoResult<Void>()
            ...
            .then(
                { geckoPrefResult ->
                    if (geckoPrefResult != null) {
                        onSuccess(geckoPrefResult.intoBrowserPreference())
                    } else {
            ...
            .then(
                { geckoPrefsResult ->
                    if (geckoPrefsResult != null) {
                        onSuccess(geckoPrefsResult.map { pref -> pref.intoBrowserPreference() })
                    } else {
    ...
    override fun setBrowserPref(
        ...
        geckoPreferenceAccessor
            .setGeckoPref(pref, value, branch.intoGeckoBranch())
            .then(
                {
                    onSuccess()
                    GeckoResult<Void>()
    ...
    override fun setBrowserPrefs(
        ...
        try {
            ...
            geckoPreferenceAccessor
                .setGeckoPrefs(geckoPrefs)
                .then(
                    { geckoPrefsResult ->
                        if (geckoPrefsResult != null) {
                            onSuccess(geckoPrefsResult)
                        } else {
    ...
    override val settings: Settings =
        object : Settings() {
                ...
                override var safeBrowsingPolicy: Array<SafeBrowsingPolicy> = arrayOf(SafeBrowsingPolicy.RECOMMENDED)
                    set(value) {
                            ...
                            with(runtime.settings.contentBlocking) {
                                ...
                                if (
                                    allowListConvenienceTrackingProtection !=
                                        value.allowListConvenienceTrackingProtection
                                ) {
                    ...
                    set(value) {
                        with(runtime.settings.contentBlocking) {
                            if (this.queryParameterStrippingAllowList.joinToString() != value) {
                                this.setQueryParameterStrippingAllowList(*value.split(",").toTypedArray())
                            }
                        }
                        field = value
                    }
                    ...
                    set(value) {
                        with(runtime.settings.contentBlocking) {
                            if (this.queryParameterStrippingStripList.joinToString() != value) {
                                this.setQueryParameterStrippingStripList(*value.split(",").toTypedArray())
                            }
                        }
                        field = value
                    }
                ...
                override var remoteDebuggingEnabled: Boolean
                    ...
                    set(value) {
                        runtime.settings.remoteDebuggingEnabled = value
                    }
                ...
                override var loginAutofillEnabled: Boolean
                    ...
                    set(value) {
                        runtime.settings.loginAutofillEnabled = value
                    }
                ...
                override var firefoxRelay: Engine.FirefoxRelayMode?
                    @OptIn(ExperimentalGeckoViewApi::class)
                    get() =
                        when (runtime.settings.firefoxRelay) {
                ...
                override var ipProtectionAuthProvider: String?
                    @OptIn(ExperimentalGeckoViewApi::class) get() = runtime.settings.ipProtectionAuthProvider
                    @OptIn(ExperimentalGeckoViewApi::class)
                    set(value) {
                ...
                override var forceUserScalableContent: Boolean
                    ...
                    set(value) {
                        runtime.settings.forceUserScalableEnabled = value
                    }
                ...
                override var httpsOnlyMode: Engine.HttpsOnlyMode
                    get() =
                        when (runtime.settings.allowInsecureConnections) {
                            ...
                            GeckoRuntimeSettings.HTTPS_ONLY -> Engine.HttpsOnlyMode.ENABLED
                                ...
                                throw java.lang.IllegalStateException("Unknown HTTPS-Only mode returned by GeckoView")
                        }
                    set(value) {
                ...
                override var dohProviderUrl: String
                    ...
                    set(value) {
                        runtime.settings.setTrustedRecursiveResolverUri(value)
                    }
                ...
                override var dohExceptionsList: List<String>
                    ...
                    set(value) {
                        runtime.settings.setTrustedRecursiveResolverExcludedDomains(value)
                    }
                ...
                override var globalPrivacyControlEnabled: Boolean
                    ...
                    set(value) {
                        runtime.settings.setGlobalPrivacyControl(value)
                    }
                ...
                override var webContentIsolationStrategy: WebContentIsolationStrategy?
                    ...
                    set(value) {
                        value?.let {
                            runtime.settings.setWebContentIsolationStrategy(it.intoWebContentIsolationStrategy())
                        }
                    }
                ...
                override var safeBrowsingRealTimeSimulationHitProbability: Int?
                    ...
                    set(value) {
                        value?.let {
                            runtime.settings.contentBlocking.setSafeBrowsingRealTimeSimulationHitProbability(it)
                        }
                    }
                ...
                override var safeBrowsingRealTimeSimulationNegativeCacheEnabled: Boolean?
                    @OptIn(ExperimentalGeckoViewApi::class)
                    get() = runtime.settings.contentBlocking.safeBrowsingRealTimeSimulationNegativeCacheEnabled
                    @OptIn(ExperimentalGeckoViewApi::class)
                    set(value) {
                        value?.let {
                ...
                override var safeBrowsingRealTimeSimulationNegativeCacheTTLSec: Int?
                    ...
                    set(value) {
                        value?.let {
                            runtime.settings.contentBlocking.setSafeBrowsingRealTimeSimulationNegativeCacheTTLSec(it)
                        }
                    }
            }
            .apply {
    ...
    internal fun ContentBlockingController.LogEntry.BlockingData.getLoadedCategory(): TrackingCategory {
        val socialTrackingProtectionEnabled = settings.trackingProtectionPolicy?.strictSocialTrackingProtection ?: false
        ...
        return when (category) {
            ...
            Event.LOADED_LEVEL_2_TRACKING_CONTENT -> {
                ...
                val isContentListActive = settings.trackingProtectionPolicy?.contains(TrackingCategory.CONTENT) ?: false
                val isStrictLevelActive =
                    runtime.settings.contentBlocking.getEnhancedTrackingProtectionLevel() ==
    ...
    private fun isCategoryActive(category: TrackingCategory) =
        settings.trackingProtectionPolicy?.contains(category) ?: false

    /**
     * Mimics the behavior for categorizing trackers from desktop, they should be kept in sync, as differences will
     * result in improper categorization for trackers.
    ...
    internal fun ContentBlockingController.LogEntry.toTrackerLog(): TrackerLog {
        ...
        val blockedCategories =
            blockingData.map { it.getBlockedCategory() }.filterNot { it == TrackingCategory.NONE }.distinct()
        val loadedCategories =
            blockingData.map { it.getLoadedCategory() }.filterNot { it == TrackingCategory.NONE }.distinct()

        /**
         * When a resource is shimmed we'll received a [REPLACED_TRACKING_CONTENT] event with the quantity
         * [BlockingData.count] of categories that were shimmed, but it doesn't specify which ones, it only tells us how
         * many. For example: { "category": REPLACED_TRACKING_CONTENT, "count": 2 }
         *
         * This indicates that there are 2 categories that were shimmed, as a result we have to infer based on the
         * categories that are active vs the amount of shimmed categories, for example:
         *
         * "blockData":
         * [ { "category": LOADED_LEVEL_1_TRACKING_CONTENT, "count": 1 }, { "category": LOADED_SOCIALTRACKING_CONTENT, "count": 1 }, { "category": REPLACED_TRACKING_CONTENT, "count": 2 } ]
         * This indicates that categories [LOADED_LEVEL_1_TRACKING_CONTENT] and [LOADED_SOCIALTRACKING_CONTENT] were
         * loaded but shimmed and we should display them as blocked instead of loaded.
         */
        val shimmedCount =
            blockingData
                .find {
        ...
        val shimmedCategories = loadedCategories.filter { isCategoryActive(it) }.take(shimmedCount)
...
internal fun ContentBlockingController.LogEntry.BlockingData.getBlockedCategory(): TrackingCategory {
    return when (category) {
        ...
        Event.REPLACED_FINGERPRINTING_CONTENT -> TrackingCategory.FINGERPRINTING

        Event.BLOCKED_CRYPTOMINING_CONTENT -> TrackingCategory.CRYPTOMINING

        Event.BLOCKED_SOCIALTRACKING_CONTENT,
        Event.COOKIES_BLOCKED_SOCIALTRACKER -> TrackingCategory.MOZILLA_SOCIAL

        Event.BLOCKED_EMAILTRACKING_CONTENT -> TrackingCategory.EMAIL

        Event.BLOCKED_TRACKING_CONTENT,
        Event.REPLACED_TRACKING_CONTENT -> TrackingCategory.SCRIPTS_AND_SUB_RESOURCES
