...
class HomepageEdgeToEdgeFeatureTest {
    ...
    @Test
    fun `GIVEN feature is enabled WHEN EdgeToEdge wallpaper is selected THEN status bar background is added`() =
        runTest(testDispatcher) {
    ...
    @Test
    fun `GIVEN EdgeToEdge wallpaper is active WHEN default wallpaper is selected THEN status bar background is removed`() =
        runTest(testDispatcher) {
            every { settings.enableHomepageEdgeToEdgeBackgroundFeature } returns true
            every { settings.shouldUseBottomToolbar } returns false
            val activity = Robolectric.buildActivity(Activity::class.java).create().get()
    ...
    @Test
    fun `GIVEN EdgeToEdge wallpaper is active WHEN feature stops THEN status bar background is removed`() =
        runTest(testDispatcher) {
            every { settings.enableHomepageEdgeToEdgeBackgroundFeature } returns true
            every { settings.shouldUseBottomToolbar } returns false
            val activity = Robolectric.buildActivity(Activity::class.java).create().get()
    ...
    @Test
    fun `GIVEN feature is stopped WHEN EdgeToEdge wallpaper is selected THEN wallpaper updates are not observed`() =
        runTest(testDispatcher) {
            every { settings.enableHomepageEdgeToEdgeBackgroundFeature } returns true
            every { settings.shouldUseBottomToolbar } returns false
            val activity = Robolectric.buildActivity(Activity::class.java).create().get()
    ...
    @Test
    fun `GIVEN private mode WHEN EdgeToEdge wallpaper is selected THEN private background is shown`() =
        runTest(testDispatcher) {
            every { settings.enableHomepageEdgeToEdgeBackgroundFeature } returns true
            every { settings.shouldUseBottomToolbar } returns false
    ...
    @Test
    fun `GIVEN search query is shown WHEN EdgeToEdge wallpaper is active THEN status bar background uses surface color`() =
        runTest(testDispatcher) {
            every { settings.enableHomepageEdgeToEdgeBackgroundFeature } returns true
            every { settings.shouldUseBottomToolbar } returns false
            val activity = Robolectric.buildActivity(Activity::class.java).create().get()
    ...
    @Test
    fun `GIVEN homepage trending and recent searches are enabled WHEN the toolbar is selected with no query on EdgeToEdge wallpaper THEN status bar background uses surface color`() =
        runTest(testDispatcher) {
            every { settings.enableHomepageEdgeToEdgeBackgroundFeature } returns true
            every { settings.shouldUseBottomToolbar } returns false
    ...
    @Test
    fun `GIVEN tab strip is enabled WHEN search query is shown on EdgeToEdge wallpaper THEN status bar background is shown`() =
        runTest(testDispatcher) {
            every { settings.enableHomepageEdgeToEdgeBackgroundFeature } returns true
            every { settings.shouldUseBottomToolbar } returns false
    ...
    @Test
    fun `GIVEN EdgeToEdge wallpaper is active WHEN EdgeToEdge wallpaper is selected again THEN status bar background is not duplicated`() =
        runTest(testDispatcher) {
            every { settings.enableHomepageEdgeToEdgeBackgroundFeature } returns true
            every { settings.shouldUseBottomToolbar } returns false
            val activity = Robolectric.buildActivity(Activity::class.java).create().get()
    ...
    @Test
    fun `GIVEN EdgeToEdge wallpaper was removed WHEN EdgeToEdge wallpaper is selected again THEN status bar background is restored`() =
        runTest(testDispatcher) {
            every { settings.enableHomepageEdgeToEdgeBackgroundFeature } returns true
            every { settings.shouldUseBottomToolbar } returns false
            val activity = Robolectric.buildActivity(Activity::class.java).create().get()
    ...
    @Test
    fun `GIVEN bottom toolbar is shown WHEN toolbar is not in edit mode THEN status bar background is transparent`() =
        runTest(testDispatcher) {
            every { settings.enableHomepageEdgeToEdgeBackgroundFeature } returns true
    ...
    @Test
    fun `GIVEN bottom toolbar is shown WHEN toolbar enters edit mode THEN status bar background is shown`() =
        runTest(testDispatcher) {
            every { settings.enableHomepageEdgeToEdgeBackgroundFeature } returns true
            every { settings.shouldUseBottomToolbar } returns true
            val activity = Robolectric.buildActivity(Activity::class.java).create().get()
